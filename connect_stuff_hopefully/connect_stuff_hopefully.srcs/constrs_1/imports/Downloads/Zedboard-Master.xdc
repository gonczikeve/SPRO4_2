...
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN Y9 [get_ports clk_10mhz]
create_clock -period 20.000 -name clk_10mhz -waveform {0.000 10.000}
...
# User LEDs - Bank 33
# ----------------------------------------------------------------------------
set_property PACKAGE_PIN T22 [get_ports {EncO[0]}]
set_property PACKAGE_PIN T21 [get_ports {EncO[1]}]
set_property PACKAGE_PIN U22 [get_ports {EncO[2]}]
set_property PACKAGE_PIN U21 [get_ports {EncO[3]}]
set_property PACKAGE_PIN V22 [get_ports {EncO[4]}]
set_property PACKAGE_PIN W22 [get_ports {Led[0]}]
set_property PACKAGE_PIN U19 [get_ports {Led[1]}]
#set_property PACKAGE_PIN U14 [get_ports {EncO[3]}];  # "LD7"
...
## ----------------------------------------------------------------------------
set_property PACKAGE_PIN F22 [get_ports {switchO[0]}]
set_property PACKAGE_PIN G22 [get_ports {switchO[1]}]
set_property PACKAGE_PIN H22 [get_ports {switchO[2]}]
set_property PACKAGE_PIN F21 [get_ports {switchO[3]}]
set_property PACKAGE_PIN H19 [get_ports {switchO[4]}]
set_property PACKAGE_PIN H18 [get_ports {switchO[5]}]
set_property PACKAGE_PIN H17 [get_ports {switchO[6]}]
set_property PACKAGE_PIN M15 [get_ports {switchO[7]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {memory[7][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[7][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[7][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[7][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[7][0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[6][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[6][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[6][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[6][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[6][0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[5][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[5][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[5][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[5][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[5][0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[4][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[4][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[4][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[4][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[4][0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[3][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[3][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[3][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[3][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[3][0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[2][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[2][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[2][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[2][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[2][0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[1][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[1][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[1][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[1][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[1][0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[0][4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[0][3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[0][2]}]
set_property IOSTANDARD LVCMOS18 [get_ports rst]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[0][1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {memory[0][0]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {switchO[5]}]
