...
#
# Generated by export_simulation on Mon May 29 00:25:21 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './fir_compiler_7.sh' script.

./fir_compiler_7.sh -reset_run
...
./fir_compiler_7.sh -noclean_files

For more information on the script, please type './fir_compiler_7.sh -help'.
